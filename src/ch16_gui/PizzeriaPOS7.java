 ...
 * 
 * Switches POS6 to use a JTable to better display multi-column order data
 * 
 *
 */
@SuppressWarnings("serial")
public class PizzeriaPOS7 extends JFrame implements ActionListener, ListSelectionListener, KeyListener, ItemListener, MouseListener {
	...
	// west region:
	JButton addPizzaBtn = new JButton("addPizzaBtn");
	...
	// center region:
	DefaultTableModel data = new DefaultTableModel(12,6); // rows, columns
	{ // initializer block:
		Object[] columnNames = {"##", "Size", "Kind", "#Top", "Topping List", "Price", "Note"};
	...
	public static void main(String[] args) {
		PizzeriaPOS7 app = new PizzeriaPOS7();
		app.setSize(1080, 800);
		app.setTitle("POS Version 7");
	...
	PizzeriaPOS7() {
		...
		orderTable.getColumnModel().getColumn(4).setPreferredWidth(230);
		...
		orderTable.getColumnModel().getColumn(5).setCellRenderer(new RightTableCellRenderer());
